# Hyperloop Spec Change Workflow
...
- **Reserved terms check.** Hyperloop has a specific domain model. Don't repurpose these terms.
...
- **Hyperloop terminology** — no reserved term collision
...
- **The Hyperloop domain model is a minefield of reserved terms.** A dedicated terminology critic is cheaper than discovering the collision during implementation.
