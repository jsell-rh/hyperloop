...
async function loadDrift(): Promise<void> {
  try {
    drift.value = await fetchSpecDrift(specRef.value)
  } catch {
    drift.value = null
  } finally {
...
async function loadSummaryRecord(): Promise<void> {
  try {
    summaryRecord.value = await fetchSpecSummaryRecord(specRef.value)
  } catch {
...
async function loadActivity(): Promise<void> {
  try {
    const activity: ActivityResponse = await fetchActivity()
