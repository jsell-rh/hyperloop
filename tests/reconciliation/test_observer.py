...
EXPECTED_METHODS: dict[str, dict[str, type]] = {
    ...
    "stale_agent_detected": {"task_id": int, "spec_path": str},
    "agent_launch_failed": {"task_id": int, "role": str, "reason": str, "cycle": int},
    "agent_tool_use": {"branch": str, "tool": str, "input_preview": str},
    "agent_text": {"branch": str, "text_preview": str},
    "agent_progress": {"branch": str, "description": str},
    "agent_error": {"branch": str, "error": str},
    "crash_recovery_started": {"stale_agent_count": int},
